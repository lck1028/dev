      ...
      <>
        <Article>
          ...
          <Main as={isIE ? 'div' : null}>
            <Route exact path={match.path} component={() => <NoticeList listUrl={listUrl} />} />
            <Route path={`${match.path}/:id`} component={() => <NoticeDetail listUrl={listUrl} />} />
          </Main>
          <Gnb />
          <FooterWrap>
            <Footer type={'notice'} />
...
const NoticeWithRouter = withRouter(Notice)
